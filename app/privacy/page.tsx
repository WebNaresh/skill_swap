...
export const metadata: Metadata = {
  ...
  description:
    "Privacy policy for SkillCircle skill exchange platform. Learn how we collect, use, and protect your personal information.",
  openGraph: {
    title: "Privacy Policy - SkillCircle",
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              SkillCircle is intended for users 18 years and older. We do not
