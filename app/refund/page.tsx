...
export const metadata: Metadata = {
  ...
  description:
    "Cancellation and refund policy for SkillCircle skill exchange platform. Learn about our policies for skill exchange cancellations and dispute resolution.",
  openGraph: {
    title: "Cancellation & Refund Policy - SkillCircle",
    description:
      "Cancellation and refund policy for SkillCircle skill exchange platform.",
    type: "website",
  },
};
          ...
          <section>
            ...
            <div className="bg-sky-50 border-l-4 border-sky-400 p-4 rounded">
              <p className="text-sky-800 font-medium">
                Important: SkillCircle facilitates skill exchanges through a
