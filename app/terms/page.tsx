...
export const metadata: Metadata = {
  ...
  description:
    "Terms and conditions for using the SkillCircle skill exchange platform. Learn about user responsibilities, platform rules, and legal agreements.",
  openGraph: {
    title: "Terms & Conditions - SkillCircle",
    description:
      "Terms and conditions for using the SkillCircle skill exchange platform.",
    type: "website",
  },
};
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 space-y-8">
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              By accessing and using SkillCircle (&quot;the Platform&quot;), you
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              SkillCircle is a skill exchange platform that enables users to
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              While we strive to maintain continuous service, SkillCircle may
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              SkillCircle serves as a platform to connect users but is not
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              SkillCircle reserves the right to modify these terms at any time.
